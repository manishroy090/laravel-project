  ...
  <div class="container">
    ...
    enctype="multipart/form-data">
        ...
        <div class="col-md-4">
            ...
            <input type="email" class="form-control" id="inputtitle" name="email" value="{{$product->email}}">
          </div>
        ...
        <fieldset class="row mb-3">
            ...
            <div >
              <div class="form-check">
                <input class="form-check-input" type="radio" name="quality" id="gridRadios1" value="option1" {{$product->quality =='option1'? 'checked': ''}}>
                <label class="form-check-label" for="gridRadios1">
                  Standard
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="quality" id="gridRadios2" value="option2" {{$product->quality =='option2'? 'checked': ''}}>
